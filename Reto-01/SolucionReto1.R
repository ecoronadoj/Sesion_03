...
# NOTA: Si _p<0.05_ se descarta la hipotesis nula, es decir que la serie tiene un comportamiento estocástico, caso contrario la serie de tiempo será no tienen comportamiento estócastico, será no estacionaria. 
